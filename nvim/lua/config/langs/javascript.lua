...
function M.add_async()
  ...
  local function_node = require("config.utils.treesitter").find_node_ancestor(
...
function M.goto_exported_symbol()
  ...
  local language_tree = require("config.utils.treesitter").get_language_tree_for_cursor_location()
